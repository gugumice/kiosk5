...
def main():
    ...
    config = kiosk_config.read_config('{}/{}'.format(run_directory, 'kiosk.ini'))
    #Set logging
    ...
    kiosk_app=KioskApp(width=480, height=800, bg_image='{}/{}'.format(config['images_lolder'],config['bg_image']))
    kiosk_app.mainloop()
